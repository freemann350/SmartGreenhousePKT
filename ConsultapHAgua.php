<?php
    ...
    if ($pg < '1'){
        header("Location: ConsultapHAgua");
    }
    
    $per_page = 15;
    $pfunc = ceil($pg*$per_page) - $per_page;
    
    $Query = "SELECT * FROM phagua ORDER BY id LIMIT $pfunc, $per_page";
    $CountData = "SELECT count(*) AS totaldados FROM phagua";
    ...
    <section id="container">
        ...
        <section id="main-content">
            <section class="wrapper site-min-height" id="wrapping">
                ...
                <h3><i class="fa fa-angle-right"></i> Dados de pH de água</h3>
