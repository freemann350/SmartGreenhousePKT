<?php
    ...
    if ($pg < '1'){
        header("Location: ConsultapHSolo");
    }
    
    $per_page = 15;
    $pfunc = ceil($pg*$per_page) - $per_page;
    
    $Query = "SELECT * FROM phsolo ORDER BY id LIMIT $pfunc, $per_page";
    $CountData = "SELECT count(*) AS totaldados FROM phsolo";
    ...
    <section id="container">
        ...
        <section id="main-content">
            <section class="wrapper site-min-height" id="wrapping">
                ...
                <h3><i class="fa fa-angle-right"></i> Dados de pH de solo</h3>
