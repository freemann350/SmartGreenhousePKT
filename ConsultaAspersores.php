<?php
    $title = "Consulta de aspersores";
    $ASP = true;
    $At = true;
    
    #LÊ ESTADO DE ATUADOR
    $myfile = fopen("shared/status_aspersores", "r");
    $status = fread($myfile,filesize("shared/status_aspersores"));
    fclose($myfile);
    ...
    if ($pg < '1'){
        header("Location: ConsultaAspersores");
    }
    
    $per_page = 15;
    $pfunc = ceil($pg*$per_page) - $per_page;
        
    $Query = "SELECT * FROM aspersores ORDER BY id LIMIT $pfunc, $per_page";
    $CountData = "SELECT count(*) AS totaldados FROM aspersores";
    ...
    <section id="container">
        ...
        <section id="main-content">
            <section class="wrapper site-min-height" id="wrapping">
                ...
                <h3><i class="fa fa-angle-right"></i> Dados de aspersores</h3>
