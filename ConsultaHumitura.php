<?php
    ...
    if ($pg < '1'){
        header("Location: ConsultaHumitura");
    }
    
    $per_page = 15;
    $pfunc = ceil($pg*$per_page) - $per_page;
        
    $Query = "SELECT * FROM humitura ORDER BY id LIMIT $pfunc, $per_page";
    $CountData = "SELECT count(*) AS totaldados FROM humitura";
    ...
    <section id="container">
        ...
        <section id="main-content">
            <section class="wrapper site-min-height" id="wrapping">
                ...
                <h3><i class="fa fa-angle-right"></i> Dados de humitura</h3>
