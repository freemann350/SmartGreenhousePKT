<?php
    $title = "Consulta de humidificador";
    $HUM = true;
    $At = true;

    #LÊ ESTADO DE ATUADOR
    $myfile = fopen("shared/status_humidificador", "r");
    $status = fread($myfile,filesize("shared/status_humidificador"));
    fclose($myfile);
    ...
    if ($pg < '1'){
        header("Location: ConsultaHumidificador");
    }
    
    $per_page = 15;
    $pfunc = ceil($pg*$per_page) - $per_page;
        
    $Query = "SELECT * FROM humidificador ORDER BY id LIMIT $pfunc, $per_page";
    $CountData = "SELECT count(*) AS totaldados FROM humidificador";
    ...
    <section id="container">
        ...
        <section id="main-content">
            <section class="wrapper site-min-height" id="wrapping">
                ...
                <h3><i class="fa fa-angle-right"></i> Dados de humidificador</h3>
